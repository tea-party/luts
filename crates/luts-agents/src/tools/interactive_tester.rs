...
mod tests {
    use super::*;
    use luts_memory::{
        BlockType, MemoryBlockBuilder, MemoryContent, SurrealConfig, SurrealMemoryStore,
    };
    ...
    async fn test_block_tool_integration() {
        ...
        let block_id_obj = luts_memory::BlockId::new(block_id);
        ...
        assert_eq!(
            ...
            &luts_memory::MemoryContent::Text("Test fact created via BlockTool".to_string())
        );
